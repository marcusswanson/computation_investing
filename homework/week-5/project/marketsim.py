...
#
# 7 - Output the values.csv - containing the date and the total value of the fund
#
#############################################
...
if __name__ == '__main__':
    ...
    for i in range(0, np.shape(adjusted_close_price)[0]):
        ...
        # 6 - Scan cash and value to create total fund value
        current_fund_value = cash + (current_shares * adjusted_close_price[i][0:len(symbols)]).sum()
